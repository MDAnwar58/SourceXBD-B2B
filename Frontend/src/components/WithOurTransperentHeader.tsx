...
import { SvgTranslateIcon } from "./SvgIcons";
...
const TransparentNavbarBottomInputSearch = dynamic(
   () => import("./TransparentNavbarBottomInputSearch"),
   {
      ssr: false,
   }
);

export default function WithOurTransperentHeader() {
   ...
   return (
      <header className=" py-3 bg-[#f0f2ff] drop-shadow-sm sticky top-0 z-50">
         <div className="container">
            <nav className="flex justify-between items-center">
               <div className="nav-left flex items-center gap-x-9">
                  <NavLink href="/">
                     <Img
                        ...
                        width={150}
                        height={45}
                        className="w-[157.08px] h-auto object-cover"
                     />
                  </NavLink>
                  {/* <button
                     type="button"
                     className="flex items-center rounded-2xl border-2 border-solid border-[#4285f4] h-10 relative"
                  >
            ...
            <TransparentNavbarBottomInputSearch />
         </div>
      </header>
   );
}
