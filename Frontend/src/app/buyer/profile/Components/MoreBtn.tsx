...
export default function MoreBtn({ userName }: Props) {
   ...
   return (
      <div ref={moreBtnRef} className=" relative">
         ...
         {moreBtn === true ? (
            <div className=" absolute top-9 right-0 bg-white/30 backdrop-blur-[10px] shadow-admin-card rounded-lg p-2">
               <NavLink href={`/buyer/profile/${userName}`}>
                  <div className="bg-slate-100 text-gray-700 hover:bg-blue-500 hover:text-white text-sm font-semibold px-3 py-1 rounded-lg transition-all duration-150 ease-in-out">
                     Edit
                  </div>
               </NavLink>
            </div>
