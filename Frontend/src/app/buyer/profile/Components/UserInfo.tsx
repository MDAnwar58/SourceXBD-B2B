...
export default function UserInfo({ name, userInfo, image }: Props) {
   return (
      <Fragment>
         <div className="bg-[#d9d9d9] rounded-[14px] 18xl:h-72 6lg:h-64 lg:h-80 xs3:h-64 xs4:h-56 h-48 relative flex items-center justify-center">
            ...
            <div className="bg-[rgba(47,47,47,0.80)] rounded-md px-4 py-1 absolute top-2 left-2">
         ...
         <div className=" pt-[5.3rem] text-[#2f2f2f] text-left font-['Raleway-Bold',_sans-serif] text-xl font-bold relative">
            {userInfo?.name || name}
         </div>
      </Fragment>
   );
