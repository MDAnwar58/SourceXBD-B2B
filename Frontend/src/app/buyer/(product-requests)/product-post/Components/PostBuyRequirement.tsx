...
export default function PostBuyRequirement() {
   return (
      <div className=" container requirement-section pb-14">
         <div
            className="bg-[#ffffff] rounded-[30px] 3xs:pb-12 pb-7 relative"
            style={{
               boxShadow:
                  "-2px -2px 10px 0px rgba(101, 101, 101, 0.25),2px 2px 10px 0px rgba(0, 0, 0, 0.25)",
            }}
         >
            <div className="sm:pt-10 4xs:pt-7 pt-5 sm:px-16 4xs:px-12 px-7 grid xl:grid-cols-2 grid-cols-1">
               ...
               <div className="w-full block">
                  <div className=" relative xl:flex hidden justify-center items-center h-[85%]">
                     <div
            ...
            <div className=" flex xl:flex-row flex-col justify-between items-end xl:gap-0 gap-3 4xs:px-12 px-7">
               <div
                  className="rounded-2xl h-[85px] xl:w-[500px] w-full relative mt-5"
                  style={{
                     background:
