...
import {
   cleanError,
   generate_quotation,
} from "./OrderHistoryVerifyDetailsAction";
...
const initialState: VerifyDetailsState = {
   recent_messages: [],
   orders: [],
   wish_products: [],
   reviews: [],
...
export const orderHistoryVerifyDetailsSlice = createSlice({
   ...
   extraReducers: (builder) => {
      builder
         ...
         .addCase(generate_quotation.pending, (state) => {
            state.loading = true;
         })
         .addCase(generate_quotation.fulfilled, (state, action) => {
            state.message = action.payload as string;
            state.loading = false; // Set loading to false on fulfilled
         })
         .addCase(generate_quotation.rejected, (state, action) => {
...
export default orderHistoryVerifyDetailsSlice.reducer;
