...
import { logoutSaller } from "@/buyer/features/BuyerCommonAction";
...
export default function BuyerEPManuBtn({ user }: { user?: any }) {
   ...
   const logout = useCallback(() => {
      ...
      socket.emit("buyerLogoutToSourceBDXServer", user?.id);
