...
export default function BuyerCountrySearchAutoComplete({
   items,
   country,
   setCountry,
   className,
         ...
         >
            <div className="relative">
               <ComboboxInput
                  className={clsx(
                     className,
                     " border-none focus:ring-0 focus:outline-none data-[focus]:outline-2 data-[focus]:-outline-offset-2 data-[focus]:outline-white/25"
                  )}
