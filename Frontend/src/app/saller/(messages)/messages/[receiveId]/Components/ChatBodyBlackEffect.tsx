...
const ChatBodyBlackEffectProduct = dynamic(
   () => import("./ChatBodyBlackEffectProduct")
);
const ChatBodyEffectImagePreview = dynamic(
   () => import("./ChatBodyEffectImagePreview")
);
const ChatBodyEffectDocumentsPreview = dynamic(
   () => import("./ChatBodyEffectDocumentsPreview")
);
