...
const ProductsModal = dynamic(() => import("./ProductsModal"));
const UploadBtns = dynamic(() => import("./UploadBtns"));
...
export default function ChatFooter({
   ...
   const handleTyping = (fromId: number, toId: number, event: any) => {
         ...
         >
            ...
            <div className="w-full relative">
               <Input
                  ...
                  onChange={(e: any) =>
                     handleTyping(Receiver?.id, authUser?.id, e)
                  }

                  // onKeyDown={() => handleStopTyping(Receiver?.id, authUser?.id)}
               />
               <Button
                  type="submit"
