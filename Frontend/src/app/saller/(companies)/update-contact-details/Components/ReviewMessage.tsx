...
export default function ReviewMessage() {
   ...
   const message = useTruncateText({
      text: " Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt, veniam unde accusamus expedita quo quaerat ullam sit et rem voluptatibus porro culpa autem maxime minus? Perspiciatis, enim. Porro, optio unde",
      wordLimit: lg6Screen
         ? 13
         : lgScreen
           ? 9
