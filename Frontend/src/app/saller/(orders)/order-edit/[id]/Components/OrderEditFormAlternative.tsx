...
export default function OrderEditFormAlternative({
   userId,
   setUserId,
   country,
   setCountry,
   ...
   const { order, buyers, products, countries, cities, error } = useSelector(
         ...
         >
            ...
            <div className="pb-3">
               ...
               {selectProducts?.length > 0 ? (
                  <div className="grid grid-cols-12 gap-3 h-full px-3 pb-3 pt-5">
            ...
            <div className="pb-3">
               ...
               <Input
                  ...
                  defaultValue={order?.location_name}
               />
               {Error?.location_name && (
                  <small className="text-red-500 text-[10px] font-semibold">
                     {Error.location_name}
            ...
            <div className="pb-3">
               <OrderCreateSelectArea
                  label="Status"
                  selectedOption={status === "paid" ? 1 : 2}
