...
type Props = {
   ...
   iconBtnClassName?: string | undefined;
   iconBtnStyle?: any | undefined;
   iconWidthAndHeight?: string | undefined;
   btnStyle?: any | undefined;
};

export default function OrderCreateSelectArea({
   label,
   selectedOption,
   options,
   arrowIcon = true,
      ...
      <Fragment>
         ...
         <div className="relative" ref={dropdownRef}>
            <div
               ...
               className={`bg-[rgba(152,176,238,0.05)] text-[#2f2f2f] font-['Raleway-Bold',_sans-serif] text-xs font-bold rounded-[10px] h-[30px] flex items-center 
            ...
            >
               ...
               {arrowIcon === true && (
                  <div
                     className={`bg-[#98b0ee] text-white rounded ${iconBtnClassName} w-[18px] h-[18px] flex items-center justify-center`}
                     style={iconBtnStyle}
                  >
                     <div className={`${iconWidthAndHeight} w-4 h-4`}>
                        <DownArrowSvgIcon />
                     </div>
                  </div>
               )}
            ...
            {dropdown !== false && (
               <div
                  className={`absolute top-8 ${top} left-0 w-full p-0 bg-[rgba(152,176,238,1)] text-white drop-shadow-sm  font-['Raleway-Bold',_sans-serif] text-xs font-bold rounded-[10px] z-20`}
               >
                  {options.length > 0
