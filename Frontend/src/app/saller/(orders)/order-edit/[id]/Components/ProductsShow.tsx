      ...
      <div className="rounded-2xl bg-white shadow-admin-card relative">
         ...
         {product?.image ? (
            <Img
               ...
               width={150}
               height={150}
               className="rounded-2xl w-full xl:h-32 4lg:h-44 lg:h-36 md:h-32 6xs:h-36 3xs:h-40 xs:h-36 xs4:h-52 xs5:h-44 h-36"
            />
         ) : null}
         <div className="px-3 pt-1 pb-2">
            ...
            <div className="text-gray-700 text-left font-['Raleway-Bold',_sans-serif] text-sm font-medium">
               BDT
               {product?.discount_price
                  ? product?.price - product?.discount_price
                  : product?.price}{" "}
               <span className=" line-through text-gray-500 text-left font-['Raleway-Bold',_sans-serif] text-xs font-light">
