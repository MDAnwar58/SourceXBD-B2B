...
const ProductCreateTable = dynamic(() => import("./ProductCreateTable"));
const SearchEngineListing = dynamic(() => import("./SearchEngineListing"));
const CheckBox = dynamic(() => import("@/components/Checkbox"));
const Button = dynamic(() => import("@/components/Button"));
const Input = dynamic(() => import("@/components/Input"));
const TextEditor = dynamic(() => import("@/saller/components/TextEditor"));
...
export default function ProductCreateForm() {
   ...
   const { categories, sub_categories, loading, error } = useSelector(
            ...
            <div className="bg-[#ffffff] rounded-[20px] w-full shadow-admin-card p-5 mb-7">
               ...
               <div className="mb-3">
                  ...
                  <Input
                     type="text"
                     inputRef={contact}
                     className="bg-[rgba(152,176,238,0.05)] text-[#515151] text-left font-['Raleway-Medium',_sans-serif] text-[10px] rounded-[10px] w-full h-[30px]shadow-admin-card border-none ring-0 focus:ring-0 px-5"
