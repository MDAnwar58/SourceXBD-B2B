...
export default function BecomeASallerRegisterForm() {
   ...
   const onHandleRegisterBecomeASupplier = () => {
      ...
      const payload = {
         ...
         country_id: Country?.id !== undefined ? Number(Country?.id) : null,
   ...
   return (
      <div className="w-full">
         <div>
            ...
            <div className="pb-7">
               <div className="text-[#515151] text-left font-['Arial-Regular',_sans-serif] text-xs leading-[115.05%] font-normal">
                  Get custom pricing plan and personalized business solutions
                  from logo.com
               </div>
            </div>
            ...
            <div
               className={`${loading === false ? "bg-blue-gradient text-[#ffffff]" : "bg-blue-gradient-disable text-[#ffffff]/70"} text-left font-['Raleway-Bold',_sans-serif] text-base leading-[117.46%] font-bold rounded-[10px] h-[47px] 3xs:w-[455px] w-full flex justify-center items-center mt-7`}
