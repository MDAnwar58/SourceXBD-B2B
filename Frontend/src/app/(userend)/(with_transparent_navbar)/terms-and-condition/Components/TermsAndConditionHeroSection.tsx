...
export default function TermsAndConditionHeroSection() {
   return (
      <div
         style={{
            background:
      ...
      >
         <div className="container">
            <div className="grid lg:grid-cols-2 grid-cols-1 pb-10 pt-[7.5rem]">
               <div className="flex items-end ">
                  <div className="pb-10">
                     <div
                        className="text-left bg-clip-text font-['Raleway-Bold',_sans-serif] text-5xl font-bold 4xs:w-[421px] w-full 4xs:flex items-center pb-7 space-y-3"
                        style={{
                           background:
                     ...
                     >
                        <div className="4xs:w-auto w-full 4xs:text-left text-center">
                           Terms
                        </div>
                        <div className="px-3 4xs:w-auto w-full 4xs:text-left text-center">
                           &amp;
                        </div>
                        <div className="4xs:w-auto w-full 4xs:text-left text-center">
                           Condition
                     ...
                     <div className="text-[#ffffff] 4xs:text-left text-center font-['Arial-Regular',_sans-serif] text-xl font-normal">
               ...
               <div className=" relative lg:my-0 my-9">
                  ...
                  <div className="w-full h-full relative flex lg:justify-end justify-center">
                     <Img
                        src="/assets/images/terms-condition.png"
                        alt="about page image"
                        width={600}
                        height={600}
                        className="lg:w-[77%] 3xs:w-[508px] w-full xl:h-[266px] lg:h-[236px] xs:h-[266px] xs3:h-[236px] xs5:h-[206px] h-[176px] md:first-line:me-5"
                     />
                  </div>
               </div>
            </div>
