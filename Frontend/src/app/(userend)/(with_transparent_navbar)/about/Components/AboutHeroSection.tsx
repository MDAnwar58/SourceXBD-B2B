         ...
         <div className="container  lg:pt-[7.5rem] pt-[11.5rem]">
            <div className="grid lg:grid-cols-2 grid-cols-1 ">
               <div className="flex items-end">
                  <div className="pb-10">
                     <div
                        className="lg:text-left text-center font-['Raleway-Bold',_sans-serif] text-5xl font-bold pb-3 xs5:w-[290px] lg:mx-0 mx-auto"
                        style={{
                           background:
                     ...
                     <div className="text-[#2f2f2f] lg:text-left text-center font-['Arial-Regular',_sans-serif] text-xl font-normal pt-3">
               ...
               <div className=" relative  lg:my-0 my-9">
                  ...
                  <div className="w-full h-full absolute left-0 top-0 md:flex hidden lg:justify-end  justify-center">
                     <div className="relative lg:w-full  4xs:w-[530px] w-full h-full">
                        <div className="bg-[rgba(172,224,255,0.30)] rounded-[50%] w-[102.19px] h-[102.19px] shadow-2xl absolute xl:left-[14.7%] lg:left-[11.7%] -left-9 top-[92.3%] transform-translate-y-middle" />
                        <div className="bg-[rgba(27,93,204,0.30)] rounded-[50%] w-[191.88px] h-[191.88px] absolute xl:left-[14.7%] lg:left-[11.7%] -left-9 -top-[4.1rem]" />
