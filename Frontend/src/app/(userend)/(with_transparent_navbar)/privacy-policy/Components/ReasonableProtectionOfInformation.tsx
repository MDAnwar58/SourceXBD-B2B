...
export default function ReasonableProtectionOfInformation() {
   return (
      <div>
         <div
            className="text-left font-['Raleway-Bold',_sans-serif] text-[32px] font-bold 3md:w-[730px]"
            style={{
               background:
         ...
         <ul className="text-[#90a8e7] text-left font-['Raleway-Regular',_sans-serif] text-base font-normal ps-10 pt-12 pb-9 md:w-[63%]">
