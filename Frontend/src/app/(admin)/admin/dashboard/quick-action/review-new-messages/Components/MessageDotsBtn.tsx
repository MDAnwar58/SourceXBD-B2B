      ...
      <div className="relative" ref={dropdownRef}>
         ...
         {isDropdownOpen === true && (
            <div className=" absolute top-0 right-9">
               <div
                  className=" bg-[rgba(240,242,255,0.40)] rounded-[10px] px-2 pt-1 pb-2 h-auto z-30 space-y-2"
                  style={{
                     boxShadow:
               ...
               >
                  <NavLink
                     href={"/saller/review/new"}
                     className="bg-[#ffffff] hover:bg-[#4285f4] hover:text-white rounded-lg  w-auto  text-[#2f2f2f] text-center font-['Raleway-Bold',_sans-serif] text-[10px] font-bold transition-all duration-150 ease-linear px-3 py-1"
                     style={{
                        boxShadow:
                           "-2px -2px 10px 0px rgba(101, 101, 101, 0.25),2px 2px 10px 0px rgba(0, 0, 0, 0.25)",
                     }}
