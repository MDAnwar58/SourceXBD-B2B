...
import ProductContext from "@/admin/products/featrues/ProductContext";
...
export default function ProductEditForm({ params }: Props) {
   ...
   const { categories, sub_categories, sellers, product, loading, error } =
      useSelector((state: AdminState) => state.admin.product);
   ...
   const remarkSelectedOptionId = productRemarkOptions.find(
         ...
         <div className="2xl:col-span-9 3lg:col-span-8 col-span-12">
            <div className="bg-[#ffffff] rounded-[20px] shadow-admin-card p-5 mb-7">
               ...
               <div className="pb-3">
                  ...
                  <TextEditor
                     ref={spacification}
                     initialValue={Product?.spacification}
                     placeholder=" "
                  />
