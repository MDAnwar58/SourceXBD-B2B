...
import BlogContext from "../../featrues/BlogContext";
...
const TagsInputWrapper = dynamic(() => import("../../../components/TagsInput"));
...
export default function BlogCreateForm() {
   ...
   return (
      <Fragment>
         <PageHeader icon={icon} title="Blog Create" searchBox={false} />
