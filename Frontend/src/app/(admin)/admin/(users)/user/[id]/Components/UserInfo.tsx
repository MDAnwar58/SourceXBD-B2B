      ...
      <Fragment>
         <div className="bg-[#d9d9d9] rounded-[14px] 18xl:h-72 6lg:h-64 lg:h-80 xs3:h-64 xs4:h-56 h-48 relative flex items-center justify-center">
            {userInfo?.companyLogo ? (
               <Img
                  src={userInfo?.companyLogo.toString()}
                  alt="user avatar"
                  width={300}
                  height={300}
            ...
            {userInfo?.role === "seller" ? (
               <div className=" capitalize bg-[rgba(66,133,244,0.60)] rounded-md px-4 py-1 absolute top-2 left-2">
                  <div className="text-[#ffffff] text-left font-['Raleway-Bold',_sans-serif] text-xs font-bold relative">
                     {userInfo?.role}
                  </div>
               </div>
            ) : (
               <div className="capitalize bg-[rgba(47,47,47,0.80)] rounded-md px-4 py-1 absolute top-2 left-2">
                  <div className="text-[#ffffff] text-left font-['Raleway-Bold',_sans-serif] text-xs font-bold relative">
                     {userInfo?.role}
                  </div>
               </div>
