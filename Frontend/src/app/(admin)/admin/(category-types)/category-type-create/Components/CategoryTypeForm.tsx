...
import { createCategoryType } from "../../featrues/CategoryTypeAcion";
...
export default function CategoryTypeForm() {
   ...
   const createCategoryTypeHandle = () => {
      const payload = {
         name: name.current?.value!,
         status: status,
      };
      dispatch(createCategoryType({ payload: payload, router }));
   };
      ...
      <Fragment>
         ...
         <div className=" flex justify-end items-center">
            <Button
               ...
               onClick={createCategoryTypeHandle}
            >
               Save
            </Button>
         </div>
