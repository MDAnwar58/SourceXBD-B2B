...
import { getSubscriptionPlan } from "@/admin/subscriptions/featrues/SubscriptionAcion";
...
export default function SubscriptionPlanForm({ params }: Props) {
   const { id } = params;
   ...
   const { subscription_plan, loading, error } = useSelector(
      (state: AdminState) => state?.admin.subscription
   );

   const subscriptionPlan = subscription_plan as SubscriptionPlan | null;
      ...
      <Fragment>
         ...
         <AdminCard className="!bg-[#ffffff] !rounded-[20px]">
            ...
            <div className="mb-3">
               ...
               <Input
                  ...
                  defaultValue={subscriptionPlan?.title}
               />
               {Errors?.title && (
                  <small className="text-red-500 text-[10px] font-semibold">
                     {Errors.title}
            ...
            <div className="mb-3">
               ...
               <Input
                  ...
                  defaultValue={subscriptionPlan?.duration}
               />
               {Errors?.duration && (
                  <small className="text-red-500 text-[10px] font-semibold">
                     {Errors.duration}
            ...
            <div className="mb-3">
               <SelectArea
                  ...
                  options={packages}
                  onHandleSelectValue={(value) => setPackage(value)} // You should pass a function
               />
               {Errors?.package && (
                  <small className="text-red-500 text-[10px] font-semibold">
                     {Errors.package}
            ...
            <div className="mb-3">
               <SelectArea
                  ...
                  selectedOption={type === "recommended" ? 1 : 0}
                  options={types}
            ...
            <div className="mb-3">
               ...
               <Input
                  ...
                  className="bg-[rgba(152,176,238,0.05)] text-[#515151] text-left font-['Arial-Regular',_sans-serif] text-[10px] font-normal w-full rounded-lg h-[30px] shadow-admin-add border-none focus:ring-0 px-4"
                  placeholder="Limit"
                  defaultValue={subscriptionPlan?.product_limit}
               />
            ...
            <div className="mb-3">
               ...
               <Input
                  ...
                  className="bg-[rgba(152,176,238,0.05)] text-[#515151] text-left font-['Arial-Regular',_sans-serif] text-[10px] font-normal w-full rounded-lg h-[30px] shadow-admin-add border-none focus:ring-0 px-4"
                  placeholder="Amount"
                  defaultValue={subscriptionPlan?.amount}
               />
               {Errors?.amount && (
                  <small className="text-red-500 text-[10px] font-semibold">
                     {Errors.amount}
         ...
         <div className="flex flex-row justify-end pt-5">
            <Button
               ...
               onClick={() => updateSubscriptionPlan(String(id))}
            >
               Update
            </Button>
         </div>
